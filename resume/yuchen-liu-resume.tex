...
Co-first author. Challenged the standard attention mechanism of computing value vectors from the residual stream, discovering that deep layers benefit from \textbf{context-free value vectors} that preserve original token information and decouple optimal inputs for keys vs. values. Proposed \textbf{Bank of Values}, a learned value-vector table for the last third of layers that eliminates the \textbf{V cache} and improves validation loss and average scores across \textbf{21 benchmarks} on \textbf{135M and 780M} models.\\
\vspace{3pt}
...
Studied whether \textbf{VLMs} can formalize visual planning tasks into solver-executable \textbf{PDDL problem files}.\\
\vspace{3pt}
...
Built agentic medical-imaging workflows for \textbf{tool selection, planning, knowledge updates}, and human-in-the-loop co-evolution.
